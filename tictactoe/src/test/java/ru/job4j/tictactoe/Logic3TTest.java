...
public class Logic3TTest {
    ...
    public void whenHasXWinner() {
        ...
        assertThat(login.isWinnerX(Figure3T::hasMarkX), is(true));
    }
    ...
    public void whenNotFill() {
        ...
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerX(Figure3T::hasMarkX), is(false));
    }
    ...
    public void whenHasOWinner() {
        ...
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerX(Figure3T::hasMarkO), is(true));
    }
